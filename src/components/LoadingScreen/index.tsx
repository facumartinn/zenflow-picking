...
import { LoadingBackgroundSvg } from '../svg/LoadingBackground'
...
const LoadingScreen: React.FC<LoadingScreenProps> = ({ message, color = Colors.mainLightBlue, duration = 3000, nextRoute }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <LoadingBackgroundSvg width={'100%'} height={'36.5%'} color={Colors.mainBlue} />
